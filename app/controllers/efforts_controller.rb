class EffortsController < ApplicationController
  ...
  private
    ...
    def effort_params
      params.require(:effort).permit(:lead_number, :lead_cost, :ta_number, :ta_cost, :hours, :accomodation, :food, :travel_medium, :travel_cost, :equipment, :catering, :catering_cost, :attendees_count, :shipping_cost, :misc, :course_prep , :course_name)
    end
end
